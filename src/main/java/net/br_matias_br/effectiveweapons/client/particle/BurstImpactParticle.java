...
public class BurstImpactParticle extends SpriteBillboardParticle {
	private final SpriteProvider spriteProvider;
	BurstImpactParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider) {
	...
	public float getSize(float tickDelta) {
		return this.scale * MathHelper.clamp(((float)this.age + tickDelta) / (float)this.maxAge * 2.75F, 0.0F, 3F);
	}
	...
	public static class Factory implements ParticleFactory<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
			BurstImpactParticle particle = new BurstImpactParticle(world, x, y, z, spriteProvider);
