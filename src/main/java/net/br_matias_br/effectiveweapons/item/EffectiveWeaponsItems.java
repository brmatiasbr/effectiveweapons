...
public class EffectiveWeaponsItems {
    ...
    public static final Item DEKAJA_TOME = registerItem("dekaja_tome", new DekajaTomeItem(new Item.Settings().maxCount(1).rarity(Rarity.RARE).maxDamage(1001)));
    public static final Item DOUBLE_BOW_SMITHING_TEMPLATE = registerItem("double_bow_smithing_template", new CustomSmithingTemplate(new Item.Settings().fireproof(), CustomSmithingTemplate.CustomSmithingTemplateType.DOUBLE_BOW));
    public static final Item DOUBLE_BOW = registerItem("double_bow", new DoubleBowItem(new Item.Settings().maxCount(1).rarity(Rarity.RARE).maxDamage(1001).fireproof()));
